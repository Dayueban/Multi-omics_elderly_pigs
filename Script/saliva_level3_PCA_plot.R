...
pp <- ggplot(b, aes(PCA1, PCA2))+ 
  ...
  xlab(paste("PC1 ( ",round(b_PC[1], digits = 2),"%"," )", sep = "")) + ##坐标轴设置
  ylab(paste("PC2 ( ",round(b_PC[2], digits = 2),"%"," )", sep = ""))+##坐标轴设置
...
ggsave("saliva_metag/saliva__PCA_plot.png", plot = p1, width = 6, height = 6, dpi = 600)
