...
# stool
alpha_df <- read.csv("stool_metag/Unigenes.absolute.s.csv",header = T,sep = ',', row.names = 1)
...
write.csv(alpha_all, "Output_data/Feces_alpha_stat.csv")
...
ggsave("Plots/Feces_alpha_compare20221107.png", plot = p_total, width = 6, height = 6, dpi = 300)
